(function(){
	...
	p.setup = function(ctx, bufferObj, el){
		...
		// if (!bufferObj.recording){
		this._rawBuffer = bufferObj.buff;
		this._buffer = bufferObj.buff;

		this.createBufferSrc(bufferObj.recording);
		// }else{
	...
	p.createBufferSrc = function(recording){
	...
	p.updateNotes = function(clickedNoteIndex){
	...
	p.getOutNode = function(){
		...
		return this._gainNode.getOutNode();
	};
